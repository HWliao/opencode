...
- **Do not invoke from another child agent.** If `code-reviewer` flags something that warrants a deeper security pass, the user, main session, or an internal command template initiates that pass — not the reviewer.
